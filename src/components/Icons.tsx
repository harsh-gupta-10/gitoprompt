...
export function SparkleIcon({ color, size = 32 }: { color: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={{ color }}>
      <path d="M12 3L13.84 9.16L20 11L13.84 12.84L12 19L10.16 12.84L4 11L10.16 9.16L12 3Z" fill="currentColor" />
    </svg>
  );
}

export function StarIcon({ color, size = 24 }: { color: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={{ color }}>
